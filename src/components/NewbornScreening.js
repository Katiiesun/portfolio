      ...
      <main className="ns-container">
        ...
        <section className="ns-section">
          ...
          <p>
            ...
            stratify, and graph data by various demographics in Excel, analyze
            those graphs, and compile findings into reports for leadership.
          </p>
        ...
        <section className="ns-takeaways">
          ...
          <div className="ns-takeaway-block">
            <h4 className="ns-takeaway-heading">
              01. Designing for Trust & Transparency
            </h4>

            <p>
              One of the biggest lessons I took away was the importance of
              designing for trust. Scientists don’t want a black box that simply
              outputs results. They need to understand the data behind a new
              cutoff value recommendation and feel confident in how conclusions
              are reached.
            </p>

            <p>
              Throughout the project, this meant prioritizing clarity by making
              all data configurations and cutoff decision rules visible,
              ensuring analysis steps were easy to follow, and designing
              interfaces that supported careful exploration rather than quick
              guesses.
            </p>

            <p>
              This became especially important as I explored the role of
              generative AI within the tool. While AI could help surface
              patterns or manipulate the data for analysis, it was equally
              important that users could review, adjust, and configure the data
              themselves.
            </p>

            <p>
              Rather than replacing the scientist’s judgment, the goal was to
              design AI as a collaborator. One that assists with complex
              analysis while keeping all data, assumptions, and configurations
          ...
          <div className="ns-takeaway-block">
            <h4 className="ns-takeaway-heading">
              02. Redefining Impact in Healthcare
            </h4>

            <p>
              Working in a healthcare context reshaped how I think about impact,
              as real-world outcomes are what measure it. On this project,
              success meant giving time back while not compromising precision
              and accuracy.
            </p>

            <p>
              Parts of the cutoff analysis workflow that once required weeks of
              manual work could now be completed in days.
            </p>

            <p>
              But that improvement wasn’t just a productivity metric. It meant
              scientists spending less time wrestling with spreadsheets and more
              time focusing on research and interpretation. It meant labs being
          ...
          <p className="ns-closing">
            <p>
              ...
              reinforced to me that the work we do as designers can support the
              people behind the science and help them make confident decisions
              that impact newborn screening outcomes for many families.
            </p>
            I’m incredibly grateful for my time as an intern at Revvity. This
            project sparked my interest in designing for health tech and I’m
