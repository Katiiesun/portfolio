    ...
    <div>
      ...
      <div className="my-artwork">
        ...
        <h2>
          ...
          and create whatever the hell I wanted. In highschool, I was in a
          visual arts program so here are some of my favourite pieces I created during those few years!{" "}
        </h2>
